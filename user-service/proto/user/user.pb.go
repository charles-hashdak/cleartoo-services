...
var file_proto_user_user_proto_rawDesc = []byte{
	...
	0x64, 0x65, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x32, 0xb4, 0x04, 0x0a, 0x0b,
...
var file_proto_user_user_proto_depIdxs = []int32{
	...
	0,  // 13: user.UserService.Auth:input_type -> user.User
	9,  // 14: user.UserService.ValidateToken:input_type -> user.Token
	1,  // 15: user.UserService.Follow:input_type -> user.Follower
	1,  // 16: user.UserService.IsFollowing:input_type -> user.Follower
	5,  // 17: user.UserService.Create:output_type -> user.Response
	5,  // 18: user.UserService.FacebookLogin:output_type -> user.Response
	5,  // 19: user.UserService.Edit:output_type -> user.Response
	5,  // 20: user.UserService.ChangePassword:output_type -> user.Response
	5,  // 21: user.UserService.ResetPassword:output_type -> user.Response
	5,  // 22: user.UserService.Get:output_type -> user.Response
	5,  // 23: user.UserService.SendNotification:output_type -> user.Response
	5,  // 24: user.UserService.GetAll:output_type -> user.Response
	5,  // 25: user.UserService.Auth:output_type -> user.Response
	9,  // 26: user.UserService.ValidateToken:output_type -> user.Token
	7,  // 27: user.UserService.Follow:output_type -> user.FollowResponse
	8,  // 28: user.UserService.IsFollowing:output_type -> user.IsFollowingResponse
